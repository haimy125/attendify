...
class LecturerCreateClassScreen extends StatefulWidget {
  const LecturerCreateClassScreen({super.key});

  @override
  State<LecturerCreateClassScreen> createState() => _CreateClassScreenState();
}

class _CreateClassScreenState extends State<LecturerCreateClassScreen> {
